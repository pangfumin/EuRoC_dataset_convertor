...
std::string save_folder = "/home/pang/data/dataset/multi_srereo/outdoor_day1_data";
...
int main(int argc, char** argv)
{
    ...
    ros::NodeHandle nh;
    message_filters::Subscriber<Image> image0_sub(nh, "/visensor/left/image_raw", 10);
    message_filters::Subscriber<Image> image1_sub(nh, "/visensor/right/image_raw", 10);
    message_filters::Subscriber<PointCloud2> lidar_sub(nh, "/velodyne_point_cloud", 10);
